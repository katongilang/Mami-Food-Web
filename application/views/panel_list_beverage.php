        ...
        <div class="col-md-10 content">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="panel-body" method="get" action="<?php echo site_url('Panel/cari_beverage') ?>" >
                    <div class="input-group col-sm-3 pull-right" id="search">
                        <input type="text" class="form-control" placeholder="Cari minuman / harga" name="srch-term" id="srch-term">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        data-href="<?php echo base_url() . 'Panel/delete_beverage/' . $m->id_menu; ?>">
              ...
              <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
                <div class="modal-dialog">
                  ...
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title custom_align" id="Heading">Edit Minuman</h4>
                  </div>

                  <form class="panel-body" action="<?php echo base_url('Panel/update_beverage')?>" method="post" enctype="multipart/form-data" role="form" >  
