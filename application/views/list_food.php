    ...
    <div class="album py-5 bg-light box-style">
        <div class="container">
        	...
        	<div class="row heading">
    				<div class="col-lg-12">	
    					<h2>List Food</h2>
      					<div class="intro">Pada halaman ini Mami Food akan menampilkan semua menu makanan. <br>Agar semua teman teman bisa melihat menu makanan tanpa harus ke lokasi
                	</div>
                </div>
